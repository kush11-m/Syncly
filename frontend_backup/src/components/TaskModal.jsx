...
export default function TaskModal({ isOpen, onClose, onSave, task, initialDate, initialStatus = "todo", team }) {
                    ...
                    <div>
                        ...
                        >
                            ...
                            {team?.members?.filter(m => m.status === 'Active').map(member => (
                                <option key={member.id} value={member.userId} className="bg-zinc-900 text-zinc-100">
                                    {member.name}
                                </option>
                            ))}
                        </select>
