...
import { getTeamPath } from "../utils/teamUrl";
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.alreadyMember) {
                        setMessage("You are already in this team. Opening workspace...");
                    } else {
                        setMessage("Successfully joined the team! Opening workspace...");
                    }

                    const targetPath = data.team ? getTeamPath(user, data.team) : "/teams";
