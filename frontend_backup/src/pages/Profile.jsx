...
import { Camera, LogOut, ArrowLeft, Shield, Users } from "lucide-react";
...
export default function Profile() {
    ...
    const updateAvatar = async (nextAvatarUrl) => {
        ...
        try {
            ...
            if (!res.ok) {
                setAvatarError(data.message || "Failed to update profile picture");
                return;
            }
            ...
            setAvatarMessage(nextAvatarUrl ? "Profile picture updated." : "Profile picture removed.");
        } catch {
            ...
            <main className="flex-1 p-6 max-w-4xl mx-auto w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative z-10">
                ...
                <section className="app-panel p-8 relative overflow-hidden group">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            <div className="relative">
                                ...
                                <label
                                    ...
                                    className="absolute -bottom-2 -right-2 inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-white/20 bg-zinc-900 text-zinc-200 transition-colors hover:bg-zinc-800"
                            ...
                            <p className="text-[11px] text-zinc-500">PNG/JPG/WEBP/GIF up to 2MB</p>
                        </div>
                    ...
                    {(avatarError || avatarMessage) && (
                        <div className={`mt-5 rounded-xl border px-4 py-3 text-sm ${avatarError ? "border-red-500/30 bg-red-500/10 text-red-200" : "border-emerald-500/30 bg-emerald-500/10 text-emerald-200"}`}>
                            {avatarError || avatarMessage}
                        </div>
                    )}
                </section>
